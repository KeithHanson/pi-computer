...
- noVNC operator access remains loopback-published for local development.
...
Do not add Docker socket mounts, `privileged: true`, `cap_add`, wildcard host binds, or raw `5900`/`9222` port mappings without a new threat-model review.
